...
object Location {
  ...
  val cfgAddress = "cfgAddress"
  val cfgIndex = "cfgIndex"
  val cfgRegion = "cfgRegion"
  val nameSuffix = "/nameSuffix.txt"
  val indexNameDrop = "/indexNameDrop.txt"
  val sourceFileName = "/home/paterake/Downloads/Master sheet V5.1 All regions Updated - For PDF production 27.5.21.xlsx"
  ...
  val language_parser_sheet = "Correct 27-5-21 for RCP"
  val tmpImageLocation = "/home/paterake/Downloads/text.png"
